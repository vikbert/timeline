...
const items = [
    ...
    },
    {
        ...
        description: 'Satoshi Nakamoto releases bitcoin white paper: Bitcoin: A Peer-to-Peer Electronic Cash System, that establishes the model for a blockchain',
    },
    {
        date: '2009',
        title: 'Bitcoin Software SourceForge',
        description: 'Nakamoto uploaded blockchain source code to SourceForge in 2008, so software developers around the world could contribute to this project. Nakamoto released version 0.1 of the Bitcoin Software, that is the first' +
    ...
    },
    {
        ...
        description: 'Blockchain technology is separated from the currency and its potential for other financial, interorganisational transactions is explored. Blockchain 2.0 is born, referring to applications beyond currency. Ethereum' +
    ...
    },
    {
        ...
        description: 'Ethereum was different with other blockchains that existed only to support specific cryptocurrencies(e.g. Bitcoin). Ethereum was introduced as a platform for running decentralized applications. The Ethereum' +
            ' blockchain' +
            ' holds executable' +
            ' source code in addition to data, so it serves as the foundation for thousands of blockchain-based applications. The Ethereum blockchain’s flexibility makes it ideal for hosting both NFTs and dApps.',
    },
    {
        date: '2015',
...
export default function Blockchain() {
    return <>
        <GlobalStyles styles={{li: {margin: '20px 0'}, p: {color: '#9b9999'}}}/>
